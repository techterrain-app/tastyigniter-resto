    ...
    protected function registerOnboardingSteps()
    {
        OnboardingSteps::registerCallback(function (OnboardingSteps $manager) {
            $manager->registerSteps([
                ...
                'admin::menu_qrcode' => [
                    'label' => 'admin::lang.dashboard.onboarding.label_qrcode',
                    'description' => 'admin::lang.dashboard.onboarding.help_qrcode',
                    'icon' => 'fa-qrcode',
                    'url' => 'https://api.qrserver.com/v1/create-qr-code/?data=https://app.restocart.co/thebestrestaurant/menu&size=1000x1000',
                ],
            ]);
        });
    }
